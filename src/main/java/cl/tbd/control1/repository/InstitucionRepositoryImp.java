...
public class InstitucionRepositoryImp implements InstitucionRepository{
    ...
    public Institucion createInstitucion(Institucion institucion){
        ...
        String SQL_INSERT = "INSERT INTO institucion(id, nombre,direccion, eliminado)" + 
                            "VALUES(:id, :nombre,:direccion, :eliminado)";
        ...
        try{
            conn.createQuery(SQL_INSERT, true)
                    ...
                    .addParameter("eliminado", institucion.getEliminado())
    ...
    public void updateInstitucion(Institucion institucion,int id){
        ...
        String SQL_UPDATE = "UPDATE institucion SET nombre = :nombre, direccion=:direccion, eliminado = :eliminado, id = :id WHERE id = :id";
        try(Connection conn = sql2o.open()) {
