...
public class HabilidadRepositoryImp implements HabilidadRepository{
    ...
    public Habilidad createHabilidad(Habilidad habilidad){
        ...
        String SQL_INSERT = "INSERT INTO habilidad(id, nombre, descripcion, eliminado)" + 
        ...
        try{
            conn.createQuery(SQL_INSERT, true)
                    ...
                    .addParameter("eliminado", habilidad.getEliminado())
                    .executeUpdate();
            return habilidad;
    ...
    public void updateHabilidad(Habilidad habilidad,int id){
        ...
        String SQL_UPDATE = "UPDATE habilidad SET nombre = :nombre, descripcion= :descripcion, eliminado = :eliminado, id = :id WHERE id = :id";
        try(Connection conn = sql2o.open()) {
