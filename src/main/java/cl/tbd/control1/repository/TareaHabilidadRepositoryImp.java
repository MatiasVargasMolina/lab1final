...
public class TareaHabilidadRepositoryImp implements TareaHabilidadRepository{
    ...
    public Tarea_Habilidad getTarea_Habilidad(int id) {
        ...
        try (Connection conn = sql2o.open()){
            return conn.createQuery("SELECT * FROM tarea_habilidad WHERE id = :id").addParameter("id",id).executeAndFetchFirst(Tarea_Habilidad.class);
        }    
    }
    ...
    public Tarea_Habilidad createTarea_Habilidad(Tarea_Habilidad tarea_Habilidad){
        ...
        String SQL_INSERT = "INSERT INTO tarea_habilidad(id, id_tarea,id_habilidad, eliminado)" + 
                            "VALUES(:id, :id_tarea,:id_habilidad,:eliminado)";
        ...
        try{
            conn.createQuery(SQL_INSERT, true)
                    ...
                    .addParameter("eliminado", tarea_Habilidad.getEliminado())
                    .executeUpdate();
    ...
    public void updateTarea_Habilidad(Tarea_Habilidad tarea_Habilidad,int id){
        ...
        String SQL_UPDATE = "UPDATE tarea_habilidad SET id_tarea = :id_tarea,id_habilidad= :id_habilidad, eliminado = :eliminado, id = :id WHERE id = :id";
        try(Connection conn = sql2o.open()) {
