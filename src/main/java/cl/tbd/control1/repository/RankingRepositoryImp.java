...
public class RankingRepositoryImp implements RankingRepository{
    ...
    public Ranking createRanking(Ranking ranking){
        ...
        String SQL_INSERT = "INSERT INTO ranking(id, id_voluntario, id_tarea, puntaje, eliminado)" + 
                            "VALUES(:id, :id_voluntario, :id_tarea, :puntaje, :eliminado)";
        ...
        try{
            conn.createQuery(SQL_INSERT, true)
                    ...
                    .addParameter("eliminado", ranking.getEliminado())
    ...
    public void updateRanking(Ranking ranking,int id){
        ...
        String SQL_UPDATE = "UPDATE ranking SET id_voluntario = :id_voluntario, id_tarea = :id_tarea, puntaje = :puntaje, eliminado = :eliminado, id = :id WHERE id = :id";
        try(Connection conn = sql2o.open()) {
