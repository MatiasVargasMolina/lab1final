...
public class VoluntarioRepositoryImp implements VoluntarioRepository{
    ...
    public Voluntario createVoluntario(Voluntario voluntario){
        ...
        String SQL_INSERT = "INSERT INTO voluntario(id, nombre, correo, contrasenia, eliminado)" + 
                            "VALUES(:id, :nombre, :correo, :contrasenia, :eliminado)";
        ...
        try{
            conn.createQuery(SQL_INSERT, true)
                    ...
                    .addParameter("eliminado", voluntario.getEliminado())
    ...
    public void updateVoluntario(Voluntario voluntario,int id){
        ...
        String SQL_UPDATE = "UPDATE voluntario SET nombre = :nombre, eliminado = :eliminado, correo= :correo, contrasenia= :contrasenia, id = :id WHERE id = :id";
        try(Connection conn = sql2o.open()) {
